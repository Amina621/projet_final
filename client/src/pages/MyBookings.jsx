          ...
          >
            ...
            <div className='flex flex-col md:flex-row'>
              <img
                ...
                alt="hotel-img"
                className='min-w-[150px] h-28 md:h-32 object-cover rounded shadow'
              />
            ...
            {/* Date & Timings */}
            <div className='flex flex-row md:flex-col md:items-start items-center md:gap-3 mt-3 md:mt-0 gap-8'>
              <div>
            ...
            <div className='flex flex-col items-start justify-center pt-3 md:pt-0'>
              <div className='flex items-center gap-2'>
                ...
                <p className={`text-sm ${booking.isPaid ? "text-green-600" : "text-red-500"}`}>
